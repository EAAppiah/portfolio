    ...
    <div class="max-w-5xl xl:max-w-7xl w-full mx-auto flex flex-col mt-2 px-0 lg:px-8">
      ...
      <section id="banner" class="flex flex-col-reverse md:flex-row items-center justify-center py-16">
        <div class="flex-1 mb-8 lg:mb-0">
          <header class="block mt-4 lg:mt-0">
            <div class="flex flex-col h-full justify-center text-center md:text-left">
              <h1 class="text-2xl md:text-4xl lg:text-6xl font-semibold leading-tight dark:text-gray-700 text-white">
                Hi, I'm Elvis,<br> Your Next Software Engineer
              </h1>
              <p class="tracking-wider dark:text-gray-600 md:text-sm text-slate-300 uppercase mt-4 mb-4">
          ...
          <div class="text-center md:text-left">
            <nuxt-link to="/about"
              ...
              <span
                class="relative px-5 py-2.5 transition-all ease-in duration-75 dark:bg-white bg-gray-900 rounded-md group-hover:bg-opacity-0">
                MEET ME👋
              </span>
            </nuxt-link>
          </div>
        ...
        <div class="hidden xl:block xl:mr-16">
          <img src="assets/images/work.jpg" alt="Profile pic" width="600" height="400" class="rounded">
        </div>
      </section>
